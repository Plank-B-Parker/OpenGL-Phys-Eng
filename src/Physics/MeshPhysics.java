...
public class MeshPhysics extends Physics{
	...
	public MeshPhysics(Mesh mesh, double mass, Vect3d pos, Quaternion orientation, Quaternion _orientation, Mat3d basis, Mat3d _basis, Mat3d scale) {
		super(mass, pos);
		this.mesh = mesh;
		this.basis = basis;
...
//		Mat3d.mult(I, scale, I);
		...
		rotation = new Rotation(pos, orientation, _orientation, basis, _basis, I);
